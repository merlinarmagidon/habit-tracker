...
# ==============================================
# ТЕСТЫ ДЛЯ МАРШРУТОВ (URL)
# Проверяем, что каждый URL ведет на правильную функцию/класс
# ==============================================
class TestUrls:
